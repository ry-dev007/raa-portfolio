          ...
          <div className="grid gap-12 md:grid-cols-2">
            ...
            <motion.div variants={aboutItemVariants} className="space-y-8">
              <h3 className="text-primary text-2xl font-semibold">
                {contactContent.leftColumn.headline}
              </h3>
              <p className="text-lg leading-relaxed">
                {contactContent.leftColumn.description}
              </p>

              {/* Contact Methods */}
              <div className="space-y-6">
                {contactContent.leftColumn.contactMethods.map((method, idx) => (
              ...
              <div className="pt-6">
                ...
                <div className="flex space-x-4">
                  {contactContent.leftColumn.social.map((social, idx) => (
                    <Link
                      key={idx}
                      href={social.url}
            ...
            <motion.div variants={aboutItemVariants} className="space-y-6">
              <h3 className="text-primary text-2xl font-semibold">
                {contactContent.rightColumn.headline}
              </h3>
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div className="grid gap-6 md:grid-cols-2">
                  {contactContent.rightColumn.form.fields
                    .slice(0, 2)
                    .map((field) => (
                      <div key={field.id}>
                        <label
                ...
                >
                  {loading
                    ? contactContent.rightColumn.form.buttonLoadingText
                    : contactContent.rightColumn.form.buttonText}
                </button>
              </form>
            </motion.div>
          </div>
